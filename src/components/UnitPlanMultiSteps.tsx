...
import { UnitPlanFormSchema } from "@/schemas";
...
function UnitPlanMultiSteps() {
    ...
    const form = useForm<z.infer<typeof UnitPlanFormSchema>>({
        resolver: zodResolver(UnitPlanFormSchema),
        defaultValues: {
            materia: "",
            grado: "",
            tema: "",
...
export default UnitPlanMultiSteps;
