...
export function DemographyTable<TData, TValue>({
    ...
    return (
        <>
            <Input
                className="max-w-sm  border  text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 mb-4"
                placeholder="Buscar"
                value={globalFilter}
