        ...
        <>
            <div className="flex items-center py-4 ">
                <Input
                    ...
                    className="max-w-sm border  text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-primary-500 focus:border-primary-500"
                />
            </div>
