...
export const DemographicSchema = z.object({
    ...
    subject: z.enum(["Matemáticas", "Lengua Española", "Ciencias Naturales", "Ciencias Sociales", "Formación Humana", "Ingles", "Frances", "Informatica", "Educación Artística", "Educación Física"], { message: "La materia tiene que ser una de las materias de la lista" }),
})